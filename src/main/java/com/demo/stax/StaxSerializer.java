...
public class StaxSerializer {
	...
	public static String xmlFilePath = "C:/Users/sbharatha/Documents/WorkStation_Spring/DemoAPI/src/main/resources/staxExample.xml";
	public static void main(String[] args) {

		String fileName = xmlFilePath;
        String rootElement = "supp.data-block";
        StaxSerializer xmlWriter = new StaxSerializer();
        Map<String,String> elementsMap = new HashMap<String, String>();
        elementsMap.put("section", "H");
        elementsMap.put("class", "29");
        elementsMap.put("subclass", "N");
        elementsMap.put("main-group", "19");
        elementsMap.put("subgroup", "187");
